...
## Teste técnico para processo seletivo Varsomics-Einstein
...
- Realize o fork deste projeto para que crie um espelho em seu repositório (ex: github.com/user-git/bioinfotest) github. Mais instruções de como fazer o fork [aqui](https://docs.github.com/pt/free-pro-team@latest/github/getting-started-with-github/fork-a-repo).
